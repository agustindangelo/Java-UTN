CREATE DATABASE  IF NOT EXISTS `nutricionista` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `nutricionista`;
...
CREATE TABLE `alimento` (
  `id_alimento` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_alimento_categoria` FOREIGN KEY (`id_categoria`) REFERENCES `categoria` (`id_categoria`) ON UPDATE CASCADE
...
CREATE TABLE `consumo_paciente` (
  ...
  CONSTRAINT `fk_consumo_alimento` FOREIGN KEY (`id_alimento`) REFERENCES `alimento` (`id_alimento`) ON UPDATE CASCADE,
  CONSTRAINT `fk_consumo_paciente` FOREIGN KEY (`dni`) REFERENCES `paciente` (`dni`) ON UPDATE CASCADE
...
INSERT INTO `consumo_paciente` VALUES ('11111111',1,'2020-09-12','merienda',3),('11111111',2,'2020-09-12','almuerzo',200),('11111111',2,'2020-09-12','desayuno',500),('11111111',12,'2020-11-23','cena',300),('11111111',12,'2020-11-24','cena',300),('11111111',20,'2020-11-23','cena',300),('11111111',20,'2020-11-24','cena',300),('11111111',25,'2020-11-23','cena',500),('11111111',25,'2020-11-24','cena',500),('11111111',30,'2020-11-20','cena',300),('11111111',30,'2020-11-23','cena',200),('11111111',30,'2020-11-24','cena',200),('11111112',1,'2020-09-12','cena',2),('11111112',3,'2020-09-12','almuerzo',50),('11111113',1,'2020-09-12','almuerzo',5),('11111113',1,'2020-09-12','otro',5);
...
CREATE TABLE `direccion` (
  ...
  CONSTRAINT `fk_direccion_localidad` FOREIGN KEY (`cod_postal`) REFERENCES `localidad` (`cod_postal`) ON UPDATE CASCADE,
  CONSTRAINT `fk_direccion_nutricionista` FOREIGN KEY (`dni`) REFERENCES `nutricionista` (`dni`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `direccion` VALUES ('22222221',2000,'Zeballos',1300,NULL,NULL),('22222222',2113,'Av. San Martin',200,NULL,NULL),('22222223',2000,'Corrientes',2213,NULL,NULL),('22222224',2000,'Dorrego',3950,NULL,NULL);
...
CREATE TABLE `estado_animo` (
  `id_estado_animo` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `nombre` varchar(45) NOT NULL,
...
CREATE TABLE `horario` (
  ...
  CONSTRAINT `fk_horario_nutricionista` FOREIGN KEY (`dni`) REFERENCES `nutricionista` (`dni`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `localidad` VALUES (1200,'Juarez'),(1500,'Buenos Aires'),(2000,'Rosario'),(2113,'Peyrano');
...
INSERT INTO `nutricionista` VALUES ('22222221','Laura','Merlo','laura','341 3142424','laura@gmail.com'),('22222222','Martina','Moron','martina','341 4134243','martina@gmail.com'),('22222223','Juan','Mendez','juan','341 5543445','juan@gmail.com'),('22222224','Paola','Martinez','paola','341 5543445','paola@gmail.com');
...
CREATE TABLE `nutricionista_paciente` (
  ...
  CONSTRAINT `fk_nutricionista_paciente_1` FOREIGN KEY (`dni_nutricionista`) REFERENCES `nutricionista` (`dni`) ON UPDATE CASCADE,
  CONSTRAINT `fk_nutricionista_paciente_2` FOREIGN KEY (`dni_paciente`) REFERENCES `paciente` (`dni`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `nutricionista_paciente` VALUES ('22222222','11111113','2020-06-15'),('22222221','11111111','2020-08-15'),('22222221','11123123','2020-11-23'),('22222221','11111111','2020-12-02');
...
CREATE TABLE `paciente_ejercicio` (
  ...
  CONSTRAINT `fk_paciente_ejercicio_1` FOREIGN KEY (`dni_paciente`) REFERENCES `paciente` (`dni`) ON UPDATE CASCADE,
  CONSTRAINT `fk_paciente_ejercicio_2` FOREIGN KEY (`id_ejercicio`) REFERENCES `ejercicio` (`id_ejercicio`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `paciente_estado_animo` (
  `dni` varchar(45) NOT NULL,
  `id_estado_animo` int(10) unsigned NOT NULL,
  `fecha` date NOT NULL,
  PRIMARY KEY (`dni`,`id_estado_animo`,`fecha`),
  KEY `fk_paciente_estado_animo_2_idx` (`id_estado_animo`),
  CONSTRAINT `fk_paciente_estado_animo_1` FOREIGN KEY (`dni`) REFERENCES `paciente` (`dni`) ON UPDATE CASCADE,
  CONSTRAINT `fk_paciente_estado_animo_2` FOREIGN KEY (`id_estado_animo`) REFERENCES `estado_animo` (`id_estado_animo`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `paciente_estado_animo` VALUES ('11111111',3,'2020-09-12'),('11111111',4,'2020-09-12'),('11111112',1,'2020-09-12');
...
CREATE TABLE `plan` (
  ...
  CONSTRAINT `fk_plan_nutricionista` FOREIGN KEY (`dni_nutricionista`) REFERENCES `nutricionista` (`dni`) ON UPDATE CASCADE,
  CONSTRAINT `fk_plan_paciente` FOREIGN KEY (`dni_paciente`) REFERENCES `paciente` (`dni`) ON UPDATE CASCADE
...
INSERT INTO `plan` VALUES (5,'2020-06-19','11111112','22222222',0,0,0,0),(6,'2020-08-02','11111113','22222223',0,0,0,0),(7,'2020-11-20','11111111','22222221',1000,300,500,400),(8,'2020-11-20','11111112','22222222',20,50,50,20);
...
CREATE TABLE `plan_alimento` (
  ...
  CONSTRAINT `fk_plan_alimento_1` FOREIGN KEY (`id_alimento`) REFERENCES `alimento` (`id_alimento`) ON UPDATE CASCADE,
  CONSTRAINT `fk_plan_alimento_2` FOREIGN KEY (`id_plan`) REFERENCES `plan` (`id_plan`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `solicitud` (
  ...
  CONSTRAINT `fk_solicitud_nutricionista` FOREIGN KEY (`dni_nutricionista`) REFERENCES `nutricionista` (`dni`) ON UPDATE CASCADE,
  CONSTRAINT `fk_solicitud_paciente` FOREIGN KEY (`dni_paciente`) REFERENCES `paciente` (`dni`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `solicitud` VALUES ('11111111','22222222','rechazada'),('11111111','22222223','pendiente'),('11111112','22222222','rechazada'),('11111113','22222221','confirmada'),('11111113','22222222','pendiente'),('11111113','22222223','confirmada'),('11123123','22222221','confirmada'),('2443432','22222224','pendiente');
...
-- Dump completed on 2020-12-08 15:27:03
