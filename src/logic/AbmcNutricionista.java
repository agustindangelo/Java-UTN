	...
	public void enviarMail(Nutricionista n, Paciente p) throws MessagingException {
		...
		try {  
			...
			message.setContent(
				 ...
				 + "</b> es tu nuevo nutricionista. Accediendo a la plataforma podr�s comenzar a registrar tus movimientos. Te recomendamos que te pongas en contacto para coordinar tu primera consulta."
				 + "<br>"
				 + "<h2>Datos de contacto del nutricionista: </h2>"
				 + "<ul>"
				 + "<li> Tel�fono: " + n.getTelefono() + "</li>"
				 + "<li> Email: " + n.getEmail() + "</li>"
				 + "<li> Direcci�n: " + n.getDireccion().getCalle() + " " + n.getDireccion().getAltura() + ", " + n.getDireccion().getLocalidad().getDenominacion() + "</li>"
				 + "</ul>",
				 "text/html"
			 ); 
